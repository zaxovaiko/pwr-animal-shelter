            ...
            <Container fluid className={styles_main["main-container"]}>
                <Row>
                    <Col xs={{offset: 1, span: 10}}>
                        <Card className={styles_top["c-navbar__title"]} body>
                            Jak pomóc
                        </Card>
                    </Col>
                </Row>
                ...
                <div className={styles_main["main-content"]}>
                    <details className={styles_main["details-row"]}>
                        ...
                        <p className={styles_main["details-main-text"]}>
                            ...
                            Dzięki wsparciu, które otrzymujemy w ramach 1%, możemy kupić m.in.:<br/><br/>

                            <ul>
                                <li>bardzo dobrą i potrzebną karmę specjalistyczną dla zwierząt,</li>
                                <li>wyposażenie gabinetu weterynaryjnego - np. specjalistyczny i nowoczesny sprzęt
                                    pomagający ratować zwierzęta,
                                </li>
                            ...
                            <div className={styles_main["details-important"]}>
                                Numer KRS: 0000154454<br/>
                                Z dopiskiem: „Dla Schroniska we Wrocławiu”
                            </div>
                    ...
                    <details className={styles_main["details-row"]}>
                        ...
                        <p className={styles_main["details-main-text"]}>
                            ...
                            Schronisko we Wrocławiu to bardzo duży obiekt, w którym jednorazowo przebywa nawet 300 zwierząt.
                            Utrzymanie ich jest kosztowne i wymagające, zwłaszcza że często trafiają do nas chorzy czy
                            zaniedbani podopieczni.
                            <br/><b>Każda złotówka jest dla nas ważna i potrzebna.</b><br/>
                            Dzięki Twojemu wsparciu możemy utrzymywać podopiecznych i zapewnić im odpowiednie warunki. Jeśli
                            chcesz nas wesprzeć finansowo, możesz to zrobić w Schronisku na miejscu, bądź przelewem
                            bankowym.

                            <br/><br/>
                            TOZ Schronisko dla Bezdomnych Zwierząt<br/>
                            ul. Ślazowa 2, 51-007 Wrocław<br/>
                    ...
                    <details className={styles_main["details-row"]}>
                        ...
                        <p className={styles_main["details-main-text"]}>
                            ...
                            Chętnie przyjmujemy <b>dary materialne</b>. Możesz je do nas przynieść w godzinach pracy Biura
                            Adopcji, bądź później – <b>dary można powierzyć ochroniarzowi</b>, który po zamknięciu
                            schroniska
                            ...
                            <p className={styles_main["details-main-text"]}>
                                ...
                                Prosimy o przynoszenie karmy mokrej i suchej, zarówno dla psów, jak i kotów.
                                Prosimy o zakup karmy ze średniej półki. Karmy najtańsze pochodzące z dyskontów nie są
                                chętnie zjadane przez nasze zwierzaki. Nie mamy jednej firmy,
                                której produkty preferujemy - ważne tylko, aby pożywienie było odżywcze i wartościowe dla
                                zwierząt.

                                <div className={styles_main["details-important"]}>
                                    Lepiej kupić kilogram dobrej jakości karmy,
                                    niż 10 kilogramów bezwartościowego pożywienia.<br/><br/>
                                </div>
                                ...
                                <br/><b>Czego <u>nie przynosić</u> do schroniska:</b>
                                <ul>
