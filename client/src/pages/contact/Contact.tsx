        ...
        <>
            ...
            <Container fluid className={styles_main["main-container"]}>
                ...
                <Row className={styles_main["info-row"]}>
                    <img className={styles_main["image-icon"]}
                         ...
                         alt="Working time"/>
                    Godziny pracy biura:<br/><br/>
                    pn-pt: 9:00 - 17:00<br/>
                    sob-niedz: 9:00 - 15:00<br/>
                </Row>

                <Row className={styles_main["info-row"]}>
                    <img className={styles_main["image-icon"]} src="https://lnp-lnr.ru/uploads/adres.png" alt="Adress"/>
                    Polska, Wrocław<br/>
                    ul. Slazowa 2<br/>
                    51-007
                </Row>
                ...
                <Row className={styles_main["info-row"]}>
                    ...
                    +48 71 362-56-74 - Biuro adopcji<br/>
                    +48 71 501-334-268 - Kierowca pogotowia<br/><br/>
