            ...
            <Container className={styles_main["main-container"]}>
                ...
                <Row className={styles_main["activity-row"]}>
                    <span className={styles_main["activity-element"]}>
                        <Image src="https://image.flaticon.com/icons/png/512/64/64431.png" alt={"animal paw"} className={styles_main["activity-img"]}/>
                ...
                <Row className={styles_main["text"]}>
                    Pomagamy ciężko chorym podopiecznym schroniska: umieszcza je w domach tymczasowych, przeprowadza diagnostykę, leczenie i znajduje domy.
                </Row>

                <Image src="http://www.petcarriers.com.au/images/site-images/pets-variety.jpg" alt={"animals photo"} className={styles_main["style-img"]}/>

                <Row className={styles_main["text-header"]}>Pomagaj z nami</Row>
                <Row className={styles_main["text"]}>
                    Chcesz wspierać schronisko? <Link to="/charity" className={styles_main["link"]}>Sprawdź czym możesz pomóc</Link>. Każda pomóc jest dla nas ważna!
                </Row>
