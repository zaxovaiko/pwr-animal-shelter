    ...
    <div className={styles["c-footer"]}>
      ...
      <Container className={styles["main-container"]}>
        <Container className={styles["info"]}>
          ...
          <Link className={styles["link"]} to="/charity">
            JAK POMÓC?
          </Link>
        ...
        <Image
          ...
          src="https://www.schroniskowroclaw.pl/images/logo-footer.png"
        />
        <Image
          className={styles["image"]}
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0jHL_iZit9md7y_hCNIh7DCUbFSXFH6r2a4Z2xqFsz6Va1HdqM9ZeLlbArlpArWazb_s&usqp=CAU"
        />
        <Row className={styles["text"]}>
          Schronisko dla bezdomnych zwierąt we Wrocławiu
        </Row>
      </Container>
    </div>
  );
